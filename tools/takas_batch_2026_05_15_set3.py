"""
Takas Batch SET3 — 4 tickers ICE-like broker-distribution + SM-tip analysis for 2026-05-15.

Set3 tickers: VBTYZ GOKNR TUCLK DAPGM

Outputs:
  output/takas_batch_2026-05-15_set3.csv      — broker-level G/H/A/3A per ticker
  output/takas_batch_2026-05-15_set3_ice.csv  — per-ticker per-day ICE
  output/takas_batch_2026-05-15_set3.md       — readable summary

Run:
  PYTHONPATH=. python tools/takas_batch_2026_05_15_set3.py
...
ASOF = "2026-05-15"
TICKERS = ["VBTYZ", "GOKNR", "TUCLK", "DAPGM"]
HIST_DAYS = 5

OUT_BROKER_CSV = f"output/takas_batch_{ASOF}_set3.csv"
OUT_ICE_CSV    = f"output/takas_batch_{ASOF}_set3_ice.csv"
OUT_MD         = f"output/takas_batch_{ASOF}_set3.md"

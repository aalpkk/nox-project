"""
Takas Batch SET2 — 9 tickers ICE-like broker-distribution analysis for 2026-05-14.

Set2 tickers: SOKE INVEO MOPAS KLYPV KMPUR BOBET FONET LILAK ETYAT

Outputs:
  output/takas_batch_2026-05-14_set2.csv      — broker-level G/H/A/3A per ticker
  output/takas_batch_2026-05-14_set2_ice.csv  — per-ticker per-day ICE
  output/takas_batch_2026-05-14_set2.md       — readable summary

Run:
  PYTHONPATH=. python tools/takas_batch_2026_05_14_set2.py
...
ASOF = "2026-05-14"
TICKERS = [
    "SOKE", "INVEO", "MOPAS", "KLYPV", "KMPUR",
    "BOBET", "FONET", "LILAK", "ETYAT",
]
HIST_DAYS = 5

OUT_BROKER_CSV = f"output/takas_batch_{ASOF}_set2.csv"
OUT_ICE_CSV    = f"output/takas_batch_{ASOF}_set2_ice.csv"
OUT_MD         = f"output/takas_batch_{ASOF}_set2.md"

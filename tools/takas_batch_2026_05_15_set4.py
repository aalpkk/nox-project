"""
Takas Batch SET4 — 7 tickers ICE-like broker-distribution + SM-tip analysis for 2026-05-15.

Set4 tickers: ISGYO AKSA LIDER SEKUR ESCOM CEOEM GSDHO

Outputs:
  output/takas_batch_2026-05-15_set4.csv      — broker-level G/H/A/3A per ticker
  output/takas_batch_2026-05-15_set4_ice.csv  — per-ticker per-day ICE
  output/takas_batch_2026-05-15_set4.md       — readable summary

Run:
  PYTHONPATH=. python tools/takas_batch_2026_05_15_set4.py
...
ASOF = "2026-05-15"
TICKERS = ["ISGYO", "AKSA", "LIDER", "SEKUR", "ESCOM", "CEOEM", "GSDHO"]
HIST_DAYS = 5

OUT_BROKER_CSV = f"output/takas_batch_{ASOF}_set4.csv"
OUT_ICE_CSV    = f"output/takas_batch_{ASOF}_set4_ice.csv"
OUT_MD         = f"output/takas_batch_{ASOF}_set4.md"
